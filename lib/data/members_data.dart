...
class MembersData {
  static List<Member> members = [
    Member(
      ...
      primaryColor: const Color(0xFF7C3AED), // 더 진한 보라색
    ...
    Member(
      ...
      primaryColor: const Color(0xFF2563EB), // 더 진한 블루
    ...
    Member(
      ...
      primaryColor: const Color(0xFFDB2777), // 더 진한 핑크
    ...
    Member(
      ...
      primaryColor: const Color(0xFFEA580C), // 더 진한 오렌지
    ...
    Member(
      ...
      primaryColor: const Color(0xFF059669), // 더 진한 민트
    ...
    Member(
      ...
      description: '막내, 메인댄서',
      primaryColor: const Color(0xFFD97706), // 더 진한 골드/옐로우
