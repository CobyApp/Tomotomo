...
class MembersData {
  static List<Member> members = [
    Member(
      ...
      primaryColor: const Color(0xFF9C5FEB), // 밝은 보라색으로 변경
    ...
    Member(
      ...
      primaryColor: const Color(0xFF4A7FDC), // 밝은 파란색으로 변경
    ...
    Member(
      ...
      primaryColor: const Color(0xFFD84F7A), // 밝은 핑크색으로 변경
    ...
    Member(
      ...
      primaryColor: const Color(0xFFE8873C), // 오렌지색으로 변경
    ...
    Member(
      ...
      primaryColor: const Color(0xFF3EB489), // 청록색(민트)으로 변경
    ...
    Member(
      ...
      description: '막내, 메인댄서',
      primaryColor: const Color(0xFFF0B83B), // 밝은 골드색으로 변경
