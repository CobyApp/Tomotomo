...
/// PAPER-CARTOON loading state: cute bouncing coral dots (chat "typing" feel).
/// Mirrors [AppLoadingBody]'s (no-arg) public API.
class PaperLoadingBody extends StatelessWidget {
  const PaperLoadingBody({super.key});

  @override
  Widget build(BuildContext context) => const PaperLoadingBodyDots();
}
